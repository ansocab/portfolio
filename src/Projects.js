  ...
  return (
    <section>
      ...
      <Row className="projects-navigation-row">
        <Nav
          className="m-auto align-items-center projects-navigation"
      ...
      <div>
        {projects.map((item, i) =>
          item.filtered === true ? (
            <Row
              key={item.name}
              className="justify-content-around align-items-center mb-5 ml-md-auto mr-md-auto project-container m-1"
            >
              <Col className="col-12 col-md-6 order-md-2 text-md-left pb-4 pb-md-0 pt-3 pt-md-0 intro-title-container info-col">
                <div className="project-title-section">
                  {item.logo ? (
                    <img
                      className="logo-image mr-3"
                      src={require(`./assets/${item.logo}`).default}
                      alt={`${item.name} logo`}
                    />
                  ) : (
                    ""
                  ...
                  <span className="d-flex justify-content-center justify-content-md-start">
                    ...
                    {item.appStoreURL ? (
                      ...
                      >
                        <img
                          src={
                            require("./assets/app-store-download.png").default
                          }
                ...
                {item.screenshots?.length ? (
                  ...
                  >
                    <img
                      ...
                      src={require(`./assets/${item.screenshots[0]}`).default}
