...
export default function Intro () {
    ...
    return (
      <div>
        ...
        <Row className="justify-content-center align-items-center intro-container m-0 mt-5">
          <Col className="col-12 col-md-7 order-md-2 text-center text-md-left pb-5 pb-md-0 pt-3 pt-md-0 intro-title-container">
              ...
              <h3>Junior Web and Mobile Developer</h3>
          </Col>
          
          <Col className="col-12 col-md-4 col-lg-4 order-md-1 pb-3 pb-md-0">
